<?php
include_once("js/wdCalendar/wdCalendar/dbconfig.php");
include_once("js/wdCalendar/wdCalendar/functions.php");
...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <link href="js/wdCalendar/wdCalendar/css/main.css" rel="stylesheet" type="text/css" />       
    <link href="js/wdCalendar/wdCalendar/css/dp.css" rel="stylesheet" />    
    <link href="js/wdCalendar/wdCalendar/css/dropdown.css" rel="stylesheet" />    
    <link href="js/wdCalendar/wdCalendar/css/colorselect.css" rel="stylesheet" />   
     
    <script src="js/wdCalendar/wdCalendar/src/jquery.js" type="text/javascript"></script>    
    <script src="js/wdCalendar/wdCalendar/src/Plugins/Common.js" type="text/javascript"></script>        
    <script src="js/wdCalendar/wdCalendar/src/Plugins/jquery.form.js" type="text/javascript"></script>     
    <script src="js/wdCalendar/wdCalendar/src/Plugins/jquery.validate.js" type="text/javascript"></script>     
    <script src="js/wdCalendar/wdCalendar/src/Plugins/datepicker_lang_US.js" type="text/javascript"></script>        
    <script src="js/wdCalendar/wdCalendar/src/Plugins/jquery.datepicker.js" type="text/javascript"></script>     
    <script src="js/wdCalendar/wdCalendar/src/Plugins/jquery.dropdown.js" type="text/javascript"></script>     
    <script src="js/wdCalendar/wdCalendar/src/Plugins/jquery.colorselect.js" type="text/javascript"></script>    
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            //debugger;
            var DATA_FEED_URL = "js/wdCalendar/wdCalendar/php/datafeed.php";
            var arrT = [];
            var tt = "{0}:{1}";
            for (var i = 0; i < 24; i++) {
  ...
  <body>    
    <div>      
      ...
      <div class="infocontainer">            
        <form action="js/wdCalendar/wdCalendar/php/datafeed.php?method=adddetails<?php echo isset($event)?"&id=".$event->Id:""; ?>" class="fform" id="fmEdit" method="post">                 
          <label>                    
            <span>                        *Subject:              
            </span>                    
